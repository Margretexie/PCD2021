const particles = [];
const numberOfParticles = 400; // 400;
const noiseScale = 5e11; // 1.2e11;
const backgroundColor = `rgb(17, 10, 20)`;
const particleSize = 3.6; // 4.8; // 2.4;
const pickSpeed = () => random([2, 3, 5]); // random([0.1, 0.1]); // random([0.2, 0.5, 0.5, 0.8, 1, 2]);
const bothDirections = true;

function setup() {
  createCanvas(windowWidth, windowHeight);
  background(backgroundColor); // comment for tranparancy
